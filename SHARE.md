...
1. **A.** Official directory, once listed: Settings → Community plugins → Browse → search **Claudius** → Install. Works on iPhone after Restricted mode is off.
...
```text
Adding Claudius to community-plugins.json.
